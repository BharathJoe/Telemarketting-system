<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_EmpDetails.aspx.cs" Inherits="Finalproject.Add_EmpDetails" %>
...
<body>
   ...
   <br />
       ...
       <br />
        ...
        <asp:Button ID="BT_Add" runat="server" Height="52px" Text="ADD" Width="133px" OnClick="BT_Add_Click" BackColor="#009900" BorderColor="#006600" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="BT_Clear" runat="server" Height="51px" Text="CLEAR" Width="132px" BackColor="#009900" BorderColor="#006600" Font-Bold="True" Font-Names="Times New Roman" ForeColor="White" OnClick="BT_Clear_Click" />
