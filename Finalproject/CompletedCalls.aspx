<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompletedCalls.aspx.cs" Inherits="Calls.CompletedCalls" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Completed Calls</title>
...
<body>
    <form id="form1" runat="server">
        <div class="aa_htmlTable" style="background-color: #dad302;">
            <h2 class="aa_h2">COMPLETED CALLS</h2>
