<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransferCalls.aspx.cs" Inherits="Calls.TransferCalls" %>
...
<body>
    <form id="form1" runat="server">
        <div class="aa_htmlTable" style="background-color: #dad302;">
            <h2 class="aa_h2">TRANSFER CALLS</h2>
            <table style="box-shadow: 0px 0px 29px black;">
                <thead>
                    <tr>
                        ...
                        <th>EMAIL</th>
                        <th>Calls</th>
                        <th style="background-color: coral;">STATUS</th>
                    </tr>
                </thead>
                <tbody>
