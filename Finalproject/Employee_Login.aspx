<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Employee_Login.aspx.cs" Inherits="Finalproject.Employee_Login" %>
...
<body>
    <form id="form1" runat="server">
     <div class ="login" style="background-image: url('background.png')"><br /><br /><br /><br /><br />
         
          <div style="text-align: center; background: black; box-shadow: 0px 0px 29px black; margin: auto; margin-top:5px; border: 1px solid #dedede; padding: 1rem; width: 20%; height: 35em;">
       ...
       <center>
        ...
        <asp:Label ID="rsmsg" runat="server" CssClass="box" Visible="False"></asp:Label><br /><br />
         <div class="box" style="background-image: none">
             ...
             <asp:Button ID="BT_EmpLogin" runat="server" BackColor="#009900" BorderColor="#006600" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Medium" ForeColor="White" OnClick="BT_EmpLogin_Click" Text="LOGIN" Width="290px" />
