...
namespace Finalproject
{
	public partial class HR_Login : System.Web.UI.Page
	{
		...
		protected void BT_HRLogin_Click(object sender, EventArgs e)
		{
			...
			OleDbCommand cmd = new OleDbCommand("Select * from  HR where Username='" + TB_UName.Text + "' and Password='" + TB_Pwd.Text + "'", con);
